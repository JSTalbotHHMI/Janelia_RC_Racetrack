...
CALIBRATION_PREFERENCE_FILE = Path(__file__).with_name("MultiBlobTracker_withLights.default_calibration.txt")
DEFAULT_FAVICON_PNG = Path(__file__).with_name("assets") / "multiblobtracker_favicon.png"
...
class TrackerApp:
    def __init__(self, capture: cv2.VideoCapture, args: argparse.Namespace, backend_name: str, actual_width: int, actual_height: int) -> None:
        ...
        self.status_scrollbar.grid(row=3, column=1, sticky="ns", pady=(12, 12))
