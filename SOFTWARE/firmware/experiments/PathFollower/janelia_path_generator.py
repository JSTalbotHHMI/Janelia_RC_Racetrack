...
class PathGeneratorApp:
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(fields, text='Samples').grid(row=1, column=0, sticky='w')
        ttk.Entry(fields, textvariable=self.segment_count_var, width=10).grid(row=1, column=1, sticky='ew', pady=2)
        ttk.Label(fields, text='Lookahead px').grid(row=2, column=0, sticky='w')
        ttk.Entry(fields, textvariable=self.lookahead_var, width=10).grid(row=2, column=1, sticky='ew', pady=2)
        ttk.Label(fields, text='Default speed').grid(row=3, column=0, sticky='w')
        ttk.Entry(fields, textvariable=self.default_speed_var, width=10).grid(row=3, column=1, sticky='ew', pady=2)
        ttk.Label(fields, text='Heading offset').grid(row=4, column=0, sticky='w')
        ttk.Entry(fields, textvariable=self.default_heading_var, width=10).grid(row=4, column=1, sticky='ew', pady=2)
